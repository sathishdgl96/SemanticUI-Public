...
| [0004](0004-browser-holds-the-sso-token.md) | ~~The browser holds the SSO token; the server persists nothing for it~~ — superseded by 0010, never implemented |
...
| [0010](0010-confidential-client-server-side-tokens.md) | The backend is a confidential client; Snowflake tokens live server-side, encrypted |
